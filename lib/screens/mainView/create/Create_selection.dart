...
import '../mytrip/driverBookingStatus.dart';
import 'Add_vehical.dart';
import 'Passenge_request.dart';
import 'Ride_Screen.dart';
import 'VehicleStorage.dart';

class SelectCrationScreen extends StatefulWidget {
  final status;
  const SelectCrationScreen({super.key, required this.status});

  @override
  State<SelectCrationScreen> createState() => _SelectCrationScreenState();
}

class _SelectCrationScreenState extends State<SelectCrationScreen> {
  @override
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      context.watch<TranslateProvider>().t('txt_welcome'),
                    ...
                    Text(
                      context.watch<TranslateProvider>().t('txt_tagline'),
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            ...
                            widget.status == true ?
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>RideStatusScreen())):
                            ...
                            child: Text(context.watch<TranslateProvider>().t('txt_as_a_passenger')),
                          ),
                        ),
                        ...
                        Expanded(
                          child: ElevatedButton(
                              onPressed: () async {
                                widget.status == true ?
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>DriverRideStatusScreen())):
                            ...
                            child: Text(context.watch<TranslateProvider>().t('txt_as_a_driver')),
                          ),
                        ),
                      ],
                    ),
